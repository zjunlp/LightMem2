...
export type RequestModuleContract<TContext, TResult = unknown> = RuntimeModuleContract<TContext, TResult>;

export type HistoryModuleContract<TContext, TResult = unknown> = RuntimeModuleContract<TContext, TResult>;
